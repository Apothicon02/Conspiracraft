...
void main() {
    ...
    if (!celestial) {
        ...
        vec4 blockLighting = pow((inBounds && globalUbo.renderToggles.y > 0) ? getLight(primaryLightPos)/vec4(20, 20, 20, maxSunlightLevel) : vec4(0, 0, 0, 1), vec4(1, 1, 1, 3))*vec4(1, 1, 1, skylight.a);

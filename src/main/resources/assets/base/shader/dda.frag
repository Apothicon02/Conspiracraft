...
void main() {
    ...
    if (!celestial) {
        ...
        vec4 blockLighting = pow((inBounds && globalUbo.renderToggles.y > 0) ? min(vec4(1), getLight(primaryLightPos)/vec4(15, 15, 15, maxSunlightLevel)) : vec4(0, 0, 0, 1), vec4(1, 1, 1, 3))*vec4(1, 1, 1, skylight.a);

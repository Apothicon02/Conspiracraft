...
public class LightBlockType extends BlockType {
    ...
    public LightBlockType(boolean solid, boolean canBlockLight, boolean collidable, boolean fluidReplacable, boolean fluid, boolean obstructHeightmap, boolean needSupport, int red, int green, int blue) {
        super(solid, canBlockLight, collidable, fluidReplacable, fluid, obstructHeightmap, needSupport);
        r = (byte) red;
        g = (byte) green;
        b = (byte) blue;
    }

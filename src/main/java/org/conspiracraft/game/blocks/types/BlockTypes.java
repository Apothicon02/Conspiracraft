...
public class BlockTypes {
    ...
    public static BlockType
            ...
            KYANITE = create(List.of(Tags.rocks), new LightBlockType(new LightBlockProperties().g(2).b(6))),WHITE_STONE = create(List.of(Tags.rocks), new BlockType(new BlockProperties())),
            IGNEOUS = create(List.of(Tags.rocks), new BlockType(new BlockProperties())),
            STONE = create(List.of(Tags.rocks), new BlockType(new BlockProperties())),

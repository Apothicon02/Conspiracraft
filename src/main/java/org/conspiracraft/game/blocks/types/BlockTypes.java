...
public class BlockTypes {
    ...
    public static BlockType ROSE = create(List.of(Tags.flowers), new BlockType(false, false, false, true, false, true));
    ...
    public static BlockType HYDRANGEA = create(List.of(Tags.flowers), new BlockType(false, false, false, true, false, false));

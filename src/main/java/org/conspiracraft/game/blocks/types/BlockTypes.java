...
public class BlockTypes {
    ...
    public static BlockType AIR = create(new BlockType(true, false, true));
    public static BlockType WATER = create(new BlockType(true, false, false, true));
    public static BlockType GRASS = create(new BlockType(false));
    public static BlockType DIRT = create(new BlockType(false));
    public static BlockType TALL_GRASS = create(new BlockType(true, false, true));
    public static BlockType ROSE = create(new BlockType(true, false, true));
    public static BlockType TORCH = create(new LightBlockType(true, false, true, 20, 15, 0));
    ...
    public static BlockType PORECAP = create(new LightBlockType(true, false, true, 0, 12, 6));
    ...
    public static BlockType HYDRANGEA = create(new BlockType(true, false, true));

...
public class ItemTypes {
    ...
    public static ItemType
            ...
            FURNACE = create(new ItemType("machine/texture/furnace").maxStackSize(64).blockToPlace(BlockTypes.STONE.id, 0).sfx(new ItemSFX(new SFX[]{Sounds.ROCK_PLACE1, Sounds.ROCK_PLACE2}, 0.5f, 0.75f))),
            KILN = create(new ItemType("machine/texture/kiln").maxStackSize(64).blockToPlace(BlockTypes.CLAY.id, 0).sfx(new ItemSFX(new SFX[]{Sounds.ROCK_PLACE1, Sounds.ROCK_PLACE2}, 0.5f, 0.75f))),
            FORGE = create(new ItemType("machine/texture/forge").maxStackSize(64).blockToPlace(BlockTypes.STEEL_PLATING.id, 0).sfx(new ItemSFX(new SFX[]{Sounds.METAL_SMALL_PLACE1, Sounds.METAL_SMALL_PLACE2}, 0.6f, 1.0f))),
            RESEARCH_TABLE = create(new ItemType("machine/texture/research_table").maxStackSize(64).blockToPlace(BlockTypes.RESEARCH_TABLE.id, 0).sfx(new ItemSFX(new SFX[]{Sounds.METAL_SMALL_PLACE1, Sounds.METAL_SMALL_PLACE2}, 0.6f, 1.0f))),
            BLUEPRINT = create(new ItemType("misc/texture/blueprint").maxStackSize(1)),
            OAK_LOG = create(List.of(ItemTags.log), new ItemType("wood/oak/texture/log").maxStackSize(64).blockToPlace(BlockTypes.OAK_LOG.id, 0).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            OAK_PLANK = create(new ItemType("wood/oak/texture/plank").blockToPlace(BlockTypes.OAK_PLANK.id, 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            OAK_BEAM = create(new ItemType("wood/oak/texture/beam").blockToPlace(BlockTypes.OAK_FENCE.id, 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            OAK_CRATE = create(new ItemType("wood/oak/texture/crate").blockToPlace(BlockTypes.OAK_FENCE.id, 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            OAK_BARREL = create(new ItemType("wood/oak/texture/barrel").blockToPlace(BlockTypes.OAK_FENCE.id, 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            OAK_FENCE = create(new ItemType("wood/oak/texture/fence").blockToPlace(BlockTypes.OAK_FENCE.id, 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            OAK_GATE = create(new ItemType("wood/oak/texture/gate").blockToPlace(BlockTypes.OAK_FENCE.id, 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            OAK_DOOR = create(new ItemType("wood/oak/texture/door").blockToPlace(BlockTypes.OAK_FENCE.id, 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            OAK_TRAPDOOR = create(new ItemType("wood/oak/texture/trapdoor").blockToPlace(BlockTypes.OAK_FENCE.id, 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            OAK_SIGN = create(new ItemType("wood/oak/texture/sign").blockToPlace(BlockTypes.OAK_FENCE.id, 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            BIRCH_LOG = create(List.of(ItemTags.log), new ItemType("wood/birch/texture/log").maxStackSize(64).blockToPlace(BlockTypes.BIRCH_LOG.id, 0).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1))),
            BIRCH_PLANK = create(new ItemType("wood/birch/texture/plank").blockToPlace(BlockTypes.BIRCH_PLANK.id, 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            BIRCH_BEAM = create(new ItemType("wood/birch/texture/beam").blockToPlace(BlockTypes.BIRCH_FENCE.id, 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            CHERRY_LOG = create(List.of(ItemTags.log), new ItemType("wood/cherry/texture/log").maxStackSize(64).blockToPlace(BlockTypes.CHERRY_LOG.id, 0).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1))),
            CHERRY_PLANK = create(new ItemType("wood/cherry/texture/plank").blockToPlace(BlockTypes.CHERRY_PLANK.id, 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            CHERRY_BEAM = create(new ItemType("wood/cherry/texture/beam").blockToPlace(BlockTypes.CHERRY_FENCE.id, 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            MAHOGANY_LOG = create(List.of(ItemTags.log), new ItemType("wood/mahogany/texture/log").maxStackSize(64).blockToPlace(BlockTypes.MAHOGANY_LOG.id, 0).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1))),
            MAHOGANY_PLANK = create(new ItemType("wood/mahogany/texture/plank").blockToPlace(BlockTypes.MAHOGANY_PLANK.id, 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            MAHOGANY_BEAM = create(new ItemType("wood/mahogany/texture/beam").blockToPlace(BlockTypes.MAHOGANY_FENCE.id, 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            ACACIA_LOG = create(List.of(ItemTags.log), new ItemType("wood/acacia/texture/log").maxStackSize(64).blockToPlace(BlockTypes.ACACIA_LOG.id, 0).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1))),
            ACACIA_PLANK = create(new ItemType("wood/acacia/texture/plank").blockToPlace(BlockTypes.ACACIA_PLANK.id, 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            ACACIA_BEAM = create(new ItemType("wood/acacia/texture/beam").blockToPlace(BlockTypes.ACACIA_FENCE.id, 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            PALM_LOG = create(List.of(ItemTags.log), new ItemType("wood/palm/texture/log").maxStackSize(64).blockToPlace(BlockTypes.PALM_LOG.id, 0).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1))),
            PALM_PLANK = create(new ItemType("wood/palm/texture/plank").blockToPlace(BlockTypes.PALM_PLANK.id, 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            PALM_BEAM = create(new ItemType("wood/palm/texture/beam").blockToPlace(BlockTypes.PALM_FENCE.id, 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            SPRUCE_LOG = create(List.of(ItemTags.log), new ItemType("wood/spruce/texture/log").maxStackSize(64).blockToPlace(BlockTypes.SPRUCE_LOG.id, 0).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1))),
            SPRUCE_PLANK = create(new ItemType("wood/spruce/texture/plank").blockToPlace(BlockTypes.SPRUCE_PLANK.id, 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            SPRUCE_BEAM = create(new ItemType("wood/spruce/texture/beam").blockToPlace(BlockTypes.SPRUCE_FENCE.id, 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            WILLOW_LOG = create(List.of(ItemTags.log), new ItemType("wood/willow/texture/log").maxStackSize(64).blockToPlace(BlockTypes.WILLOW_LOG.id, 0).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1))),
            WILLOW_PLANK = create(new ItemType("wood/willow/texture/plank").blockToPlace(BlockTypes.WILLOW_PLANK.id, 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            WILLOW_BEAM = create(new ItemType("wood/willow/texture/beam").blockToPlace(BlockTypes.WILLOW_FENCE.id, 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            REDWOOD_LOG = create(List.of(ItemTags.log), new ItemType("wood/redwood/texture/log").maxStackSize(64).blockToPlace(BlockTypes.REDWOOD_LOG.id, 0).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1))),
            REDWOOD_PLANK = create(new ItemType("wood/redwood/texture/plank").blockToPlace(BlockTypes.REDWOOD_PLANK.id, 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            REDWOOD_BEAM = create(new ItemType("wood/redwood/texture/beam").blockToPlace(BlockTypes.REDWOOD_FENCE.id, 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            DRIFTWOOD = create(new ItemType("wood/texture/driftwood").blockToPlace(BlockTypes.BIRCH_PLANK.id, 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.33f, 1.33f))),
            STICK = create(new ItemType("wood/texture/stick").maxStackSize(64).blockToPlace(BlockTypes.STICK.id, 0).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.33f, 1.33f))),
            PEBBLE = create(new ItemType("resource/texture/pebble").maxStackSize(64).blockToPlace(BlockTypes.PEBBLE.id, 0).sfx(new ItemSFX(new SFX[]{Sounds.ROCK_PLACE1, Sounds.ROCK_PLACE2}, 0.5f, 0.75f))),
            STONE = create(List.of(ItemTags.stone), new ItemType("resource/texture/stone").maxStackSize(64).blockToPlace(BlockTypes.STONE.id, 0).sfx(new ItemSFX(new SFX[]{Sounds.ROCK_PLACE1, Sounds.ROCK_PLACE2}, 0.5f, 0.75f))),
            MARBLE = create(List.of(ItemTags.stone), new ItemType("resource/texture/marble").blockToPlace(BlockTypes.MARBLE.id, 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.ROCK_PLACE1, Sounds.ROCK_PLACE2}, 0.45f, 0.85f))),
            ...
            SANDSTONE = create(List.of(ItemTags.stone), new ItemType("resource/texture/sandstone").maxStackSize(64).blockToPlace(BlockTypes.SANDSTONE.id, 0).sfx(new ItemSFX(new SFX[]{Sounds.ROCK_PLACE1, Sounds.ROCK_PLACE2}, 0.5f, 1.f))),
            ...
            RED_SANDSTONE = create(List.of(ItemTags.stone), new ItemType("resource/texture/red_sandstone").maxStackSize(64).blockToPlace(BlockTypes.RED_SANDSTONE.id, 0).sfx(new ItemSFX(new SFX[]{Sounds.ROCK_PLACE1, Sounds.ROCK_PLACE2}, 0.5f, 1.f))),
            ...
            IRON_PLATE = create(new ItemType("component/texture/iron_plate").maxStackSize(64).blockToPlace(BlockTypes.IRON_PLATING.id, 0).sfx(new ItemSFX(new SFX[]{Sounds.METAL_SMALL_PLACE1, Sounds.METAL_SMALL_PLACE2}, 0.6f, 1.0f))),
            ...
            BAMBOO = create(new ItemType("plant/texture/bamboo").maxStackSize(64).blockToPlace(BlockTypes.BAMBOO.id, 0).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.15f))),
            PAPER = create(new ItemType("component/texture/paper").maxStackSize(64).blockToPlace(BlockTypes.PAPER.id, 0).sfx(new ItemSFX(new SFX[]{Sounds.CLOUD}, 0.5f, 0.75f)));

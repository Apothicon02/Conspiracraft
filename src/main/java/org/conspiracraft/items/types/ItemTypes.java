...
public class ItemTypes {
    ...
    public static ItemType
            ...
            DRIFTWOOD = create(new ItemType("resource/texture/driftwood").maxStackSize(64).blockToPlace(BlockTypes.BIRCH_PLANK.id, 0).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.33f, 1.33f))),

...
public class ItemTypes {
    ...
    public static ItemType
            ...
            OAK_LOG = create(List.of(ItemTags.log), new ItemType("wood/texture/oak_log").maxStackSize(64).blockToPlace(BlockTypes.OAK_LOG.id, 0).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1))),
            BIRCH_LOG = create(List.of(ItemTags.log), new ItemType("wood/texture/birch_log").maxStackSize(64).blockToPlace(BlockTypes.BIRCH_LOG.id, 0).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1))),
            CHERRY_LOG = create(List.of(ItemTags.log), new ItemType("wood/texture/cherry_log").maxStackSize(64).blockToPlace(BlockTypes.CHERRY_LOG.id, 0).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1))),
            MAHOGANY_LOG = create(List.of(ItemTags.log), new ItemType("wood/texture/mahogany_log").maxStackSize(64).blockToPlace(BlockTypes.MAHOGANY_LOG.id, 0).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1))),
            ACACIA_LOG = create(List.of(ItemTags.log), new ItemType("wood/texture/acacia_log").maxStackSize(64).blockToPlace(BlockTypes.ACACIA_LOG.id, 0).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1))),
            PALM_LOG = create(List.of(ItemTags.log), new ItemType("wood/texture/palm_log").maxStackSize(64).blockToPlace(BlockTypes.PALM_LOG.id, 0).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1))),
            SPRUCE_LOG = create(List.of(ItemTags.log), new ItemType("wood/texture/spruce_log").maxStackSize(64).blockToPlace(BlockTypes.SPRUCE_LOG.id, 0).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1))),
            WILLOW_LOG = create(List.of(ItemTags.log), new ItemType("wood/texture/willow_log").maxStackSize(64).blockToPlace(BlockTypes.WILLOW_LOG.id, 0).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1))),
            REDWOOD_LOG = create(List.of(ItemTags.log), new ItemType("wood/texture/redwood_log").maxStackSize(64).blockToPlace(BlockTypes.REDWOOD_LOG.id, 0).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1))),
            OAK_PLANK = create(new ItemType("wood/texture/oak_plank").blockToPlace(BlockTypes.OAK_PLANK.id, 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            BIRCH_PLANK = create(new ItemType("wood/texture/birch_plank").blockToPlace(BlockTypes.BIRCH_PLANK.id, 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            CHERRY_PLANK = create(new ItemType("wood/texture/cherry_plank").blockToPlace(BlockTypes.CHERRY_PLANK.id, 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            MAHOGANY_PLANK = create(new ItemType("wood/texture/mahogany_plank").blockToPlace(BlockTypes.MAHOGANY_PLANK.id, 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            ACACIA_PLANK = create(new ItemType("wood/texture/acacia_plank").blockToPlace(BlockTypes.ACACIA_PLANK.id, 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            PALM_PLANK = create(new ItemType("wood/texture/palm_plank").blockToPlace(BlockTypes.PALM_PLANK.id, 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            SPRUCE_PLANK = create(new ItemType("wood/texture/spruce_plank").blockToPlace(BlockTypes.SPRUCE_PLANK.id, 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            WILLOW_PLANK = create(new ItemType("wood/texture/willow_plank").blockToPlace(BlockTypes.WILLOW_PLANK.id, 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            REDWOOD_PLANK = create(new ItemType("wood/texture/redwood_plank").blockToPlace(BlockTypes.REDWOOD_PLANK.id, 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            ...
            OAK_BEAM = create(new ItemType("wood/texture/oak_beam").blockToPlace(BlockTypes.OAK_FENCE.id, 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            BIRCH_BEAM = create(new ItemType("wood/texture/birch_beam").blockToPlace(BlockTypes.BIRCH_FENCE.id, 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            CHERRY_BEAM = create(new ItemType("wood/texture/cherry_beam").blockToPlace(BlockTypes.CHERRY_FENCE.id, 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            MAHOGANY_BEAM = create(new ItemType("wood/texture/mahogany_beam").blockToPlace(BlockTypes.MAHOGANY_FENCE.id, 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            ACACIA_BEAM = create(new ItemType("wood/texture/acacia_beam").blockToPlace(BlockTypes.ACACIA_FENCE.id, 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            PALM_BEAM = create(new ItemType("wood/texture/palm_beam").blockToPlace(BlockTypes.PALM_FENCE.id, 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            SPRUCE_BEAM = create(new ItemType("wood/texture/spruce_beam").blockToPlace(BlockTypes.SPRUCE_FENCE.id, 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            WILLOW_BEAM = create(new ItemType("wood/texture/willow_beam").blockToPlace(BlockTypes.WILLOW_FENCE.id, 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            REDWOOD_BEAM = create(new ItemType("wood/texture/redwood_beam").blockToPlace(BlockTypes.REDWOOD_FENCE.id, 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),

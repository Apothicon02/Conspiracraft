...
public class ItemTypes {
    ...
    public static ItemType
            ...
            STEEL_HATCHET = create(new ToolItemType("tool/steel/texture/hatchet", 50, 40, new BlockTag[]{BlockTags.hatchetEfficient}).maxStackSize(1).sfx(new ItemSFX(new SFX[]{Sounds.METAL_SMALL_PLACE1, Sounds.METAL_SMALL_PLACE2}, 0.3f, 0.7f))),

...
public class ItemTypes {
    ...
    public static ItemType
            ...
            FURNACE = create(new ItemType("machine/texture/furnace").maxStackSize(64).blockToPlace(BlockTypes.STEEL_PLATING.id, 0).sfx(new ItemSFX(new SFX[]{Sounds.METAL_SMALL_PLACE1, Sounds.METAL_SMALL_PLACE2}, 0.6f, 1.0f))),
            KILN = create(new ItemType("machine/texture/kiln").maxStackSize(64).blockToPlace(BlockTypes.STEEL_PLATING.id, 0).sfx(new ItemSFX(new SFX[]{Sounds.METAL_SMALL_PLACE1, Sounds.METAL_SMALL_PLACE2}, 0.6f, 1.0f))),
            ...
            OAK_LOG = create(List.of(ItemTags.log), new ItemType("wood/oak/texture/log").maxStackSize(64).blockToPlace(BlockTypes.OAK_LOG.id, 0).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1))),

...
public class ItemTypes {
    ...
    public static ItemType
            ...
            DRIFTWOOD = create(new ItemType("resource/texture/driftwood").blockToPlace(BlockTypes.BIRCH_PLANK.id, 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.33f, 1.33f))),
            OAK_BEAM = create(new ItemType("component/texture/oak_beam").blockToPlace(BlockTypes.OAK_FENCE.id, 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            BIRCH_BEAM = create(new ItemType("component/texture/birch_beam").blockToPlace(BlockTypes.BIRCH_FENCE.id, 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            CHERRY_BEAM = create(new ItemType("component/texture/cherry_beam").blockToPlace(BlockTypes.CHERRY_FENCE.id, 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            MAHOGANY_BEAM = create(new ItemType("component/texture/mahogany_beam").blockToPlace(BlockTypes.MAHOGANY_FENCE.id, 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            ACACIA_BEAM = create(new ItemType("component/texture/acacia_beam").blockToPlace(BlockTypes.ACACIA_FENCE.id, 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            PALM_BEAM = create(new ItemType("component/texture/palm_beam").blockToPlace(BlockTypes.PALM_FENCE.id, 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            SPRUCE_BEAM = create(new ItemType("component/texture/spruce_beam").blockToPlace(BlockTypes.SPRUCE_FENCE.id, 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            WILLOW_BEAM = create(new ItemType("component/texture/willow_beam").blockToPlace(BlockTypes.WILLOW_FENCE.id, 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            REDWOOD_BEAM = create(new ItemType("component/texture/redwood_beam").blockToPlace(BlockTypes.REDWOOD_FENCE.id, 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),

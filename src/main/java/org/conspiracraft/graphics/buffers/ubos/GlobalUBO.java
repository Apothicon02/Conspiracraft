...
public class GlobalUBO extends UBO {
    ...
    public void update(MemoryStack stack) {
        ...
        ((Vector4i)uniformStorage[4]).set(Settings.shadowsEnabled ? 1 : 0, Settings.reflectionsEnabled ? 1 : 0, Settings.upscaled ? 1 : 0, 0);
        ...
        uniformStorage[16] = World.worldType.getSeason();
    }

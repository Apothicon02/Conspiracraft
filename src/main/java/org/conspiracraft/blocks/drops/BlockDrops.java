...
public class BlockDrops {
    public static Map<BlockType, Map<Pair<Float, Integer>[], Item>> blockTypeDropTable = Map.ofEntries(
            ...
            Map.entry(BlockTypes.ORANGE_SAND, LootTables.MARTIAN_REGOLITH),
            Map.entry(BlockTypes.ORANGE_SANDSTONE, LootTables.REGOLITH),
            Map.entry(BlockTypes.WET_SAND, LootTables.WET_SAND),
            ...
            Map.entry(BlockTypes.PEBBLE, LootTables.PEBBLE),

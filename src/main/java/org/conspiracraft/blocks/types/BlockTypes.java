...
public class BlockTypes {
    ...
    public static final BlockType
            ...
            OAK_BARREL = create(List.of(BlockTags.hatchetEfficient), new CrateBlockType(blockTypeMap.size(), "misc/model/cube", Map.of(Utils.packColor(255), Materials.BARREL),
                    ...
                    new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 1, 1, new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 1, 1))),
            BIRCH_FENCE = create(List.of(BlockTags.hatchetEfficient), new FenceBlockType(blockTypeMap.size(), "crafted/model/picket_fence", Map.of(Utils.packColor(255), Materials.BIRCH_PLANK, Utils.packColor(255, 0, 0, 255), Materials.BIRCH_LOG),
                    OAK_FENCE.blockProperties.copy())),

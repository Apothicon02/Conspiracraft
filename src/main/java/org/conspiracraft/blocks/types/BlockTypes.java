...
public class BlockTypes {
    public static int blockTexWidth = 16;
    ...
    public static final BlockType
            ...
            MAHOGANY_LOG = create(List.of(BlockTags.hatchetEfficient), new BlockType(blockTypeMap.size(), "misc/model/cube", Map.of(Utils.packColor(255), Materials.MAHOGANY_LOG),
                    OAK_LOG.blockProperties)), //20
            ...
            SNOW = create(List.of(BlockTags.spadeEfficient), new BlockType(blockTypeMap.size(), "misc/model/cube", Map.of(Utils.packColor(255), Materials.SNOW),  new BlockProperties().hasSlab().resistance(1).blockSFX(
                    new SFX[]{Sounds.GRAVEL_STEP1, Sounds.GRAVEL_STEP2}, 0.5f, 0.8f, new SFX[]{Sounds.GRAVEL_STEP1, Sounds.GRAVEL_STEP2}, 0.5f, 0.8f))),
            GRAVEL = create(List.of(BlockTags.sediment, BlockTags.spadeEfficient), new PowderBlockType(blockTypeMap.size(), "misc/model/cube", Map.of(Utils.packColor(255), Materials.GRAVEL),  SAND.blockProperties.copy().blockSFX(
                    new SFX[]{Sounds.GRAVEL_STEP1, Sounds.GRAVEL_STEP2}, 0.4f, 1, new SFX[]{Sounds.GRAVEL_STEP1, Sounds.GRAVEL_STEP2}, 0.4f, 1))), //55
            FLINT = create(List.of(BlockTags.pickEfficient, BlockTags.blunt), new BlockType(blockTypeMap.size(), "misc/model/cube", Map.of(Utils.packColor(255), Materials.FLINT),
                    new BlockProperties().hasSlab())),
            MUD = create(List.of(BlockTags.sediment, BlockTags.spadeEfficient), new BlockType(blockTypeMap.size(), "misc/model/cube", Map.of(Utils.packColor(255), Materials.MUD),
                    new BlockProperties().hasSlab().resistance(1).blockSFX(
            ...
            ORANGE_SANDSTONE = create(List.of(BlockTags.pickEfficient, BlockTags.blunt), new BlockType(blockTypeMap.size(), "misc/model/cube", Map.of(Utils.packColor(255), Materials.ORANGE_SANDSTONE),
                    SANDSTONE.blockProperties.copy())),
            RED_SAND = create(List.of(BlockTags.sediment, BlockTags.sand, BlockTags.spadeEfficient), new PowderBlockType(blockTypeMap.size(), "misc/model/cube", Map.of(Utils.packColor(255), Materials.RED_SAND),
                    SAND.blockProperties.copy())), //70
            RED_SANDSTONE = create(List.of(BlockTags.pickEfficient, BlockTags.blunt), new BlockType(blockTypeMap.size(), "misc/model/cube", Map.of(Utils.packColor(255), Materials.RED_SANDSTONE),
                    SANDSTONE.blockProperties.copy())),
            ...
            WET_SAND = create(List.of(BlockTags.sediment, BlockTags.sand, BlockTags.spadeEfficient), new PowderBlockType(blockTypeMap.size(), "misc/model/cube", Map.of(Utils.packColor(255), Materials.WET_SAND),  SAND.blockProperties.copy())),
            ICE = create(List.of(BlockTags.pickEfficient, BlockTags.blunt), new BlockType(blockTypeMap.size(), "misc/model/cube", Map.of(Utils.packColor(255), Materials.ICE),  GLASS.blockProperties.copy().blocksLight(true))),
            ...
            DEAD_LEAVES = create(List.of(BlockTags.hatchetEfficient, BlockTags.leaves), new BlockType(blockTypeMap.size(), "tree/model/oak_leaves", Map.of(Utils.packColor(255), Materials.DEAD_LEAVES),
                    OAK_LEAVES.blockProperties)),
            ...
            OAK_FENCE = create(List.of(BlockTags.hatchetEfficient), new FenceBlockType(blockTypeMap.size(), "crafted/model/fence", Map.of(Utils.packColor(255), Materials.OAK_PLANK, Utils.packColor(255, 0, 0, 255), Materials.OAK_LOG),
                    new BlockProperties().isSolid(false).blocksLight(false).obstructsHeightmap(false).resistance(1).blockSFX(
                    new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 1, 1, new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 1, 1))),
            BIRCH_FENCE = create(List.of(BlockTags.hatchetEfficient), new FenceBlockType(blockTypeMap.size(), "crafted/model/fence", Map.of(Utils.packColor(255), Materials.BIRCH_PLANK, Utils.packColor(255, 0, 0, 255), Materials.BIRCH_LOG),
            ...
            CHERRY_FENCE = create(List.of(BlockTags.hatchetEfficient), new FenceBlockType(blockTypeMap.size(), "crafted/model/fence", Map.of(Utils.packColor(255), Materials.CHERRY_PLANK, Utils.packColor(255, 0, 0, 255), Materials.CHERRY_LOG),
                    OAK_FENCE.blockProperties.copy())),
            MAHOGANY_FENCE = create(List.of(BlockTags.hatchetEfficient), new FenceBlockType(blockTypeMap.size(), "crafted/model/fence", Map.of(Utils.packColor(255), Materials.MAHOGANY_PLANK, Utils.packColor(255, 0, 0, 255), Materials.MAHOGANY_LOG),
                    OAK_FENCE.blockProperties.copy())),
            ...
            PALM_FENCE = create(List.of(BlockTags.hatchetEfficient), new FenceBlockType(blockTypeMap.size(), "crafted/model/fence", Map.of(Utils.packColor(255), Materials.PALM_PLANK, Utils.packColor(255, 0, 0, 255), Materials.PALM_LOG),
                    OAK_FENCE.blockProperties.copy())),
            SPRUCE_FENCE = create(List.of(BlockTags.hatchetEfficient), new FenceBlockType(blockTypeMap.size(), "crafted/model/fence", Map.of(Utils.packColor(255), Materials.SPRUCE_PLANK, Utils.packColor(255, 0, 0, 255), Materials.SPRUCE_LOG),
                    OAK_FENCE.blockProperties.copy())),
            WILLOW_FENCE = create(List.of(BlockTags.hatchetEfficient), new FenceBlockType(blockTypeMap.size(), "crafted/model/fence", Map.of(Utils.packColor(255), Materials.WILLOW_PLANK, Utils.packColor(255, 0, 0, 255), Materials.WILLOW_LOG),
                    OAK_FENCE.blockProperties.copy())),
            REDWOOD_FENCE = create(List.of(BlockTags.hatchetEfficient), new FenceBlockType(blockTypeMap.size(), "crafted/model/fence", Map.of(Utils.packColor(255), Materials.REDWOOD_PLANK, Utils.packColor(255, 0, 0, 255), Materials.REDWOOD_LOG),
                    OAK_FENCE.blockProperties.copy())),
    ...
    public static void fillTexture(MemoryStack stack) throws IOException {
        ...
        for (int i = 0; i < blockTypes.length; i++) {
            ...
            BufferedImage image = type.materials == BlockType.defaultMaterials ? Utils.loadImage("block/misc/model/cube") : Utils.loadImage("block/"+type.name);
            ...
            if (height > blockTexWidth*3) {
                ...
                copyLeafpileTexture(blockBuf, i, 2, (blockTexHeight) * Textures.atlas.width * 4L);
                copyLeafpileTexture(blockBuf, i, 4, (blockTexHeight*2L) * Textures.atlas.width * 4L);
                copyLeafpileTexture(blockBuf, i, 6, (blockTexHeight*3L) * Textures.atlas.width * 4L);
                copyLeafpileTexture(blockBuf, i, 8, (blockTexHeight*4L) * Textures.atlas.width * 4L);
                copyLeafpileTexture(blockBuf, i, 10, (blockTexHeight*5L) * Textures.atlas.width * 4L);
                copyLeafpileTexture(blockBuf, i, 12, (blockTexHeight*6L) * Textures.atlas.width * 4L);
                copyLeafpileTexture(blockBuf, i, 14, (blockTexHeight*7L) * Textures.atlas.width * 4L);
            } else {
    ...
    public static void copyTexture(ByteBuffer buf, int i, int height, long offset, long dstOffset) {
        for (long row = offset; row < height; row++) {
            memCopy(memAddress(buf) + (row * blockTexWidth * 4L),
                    atlasBuffer.pointer.get(0) + dstOffset + ((row * Textures.atlas.width + (i * blockTexWidthL)) * 4L),
                    blockTexWidth * 4L);
        }
    }
    ...
    public static void copyTopSlabTexture(ByteBuffer buf, int i, boolean alt, long offset) {
        for (long row = 0; row < blockTexWidth; row++) {
            for (long layer = 0; layer < blockTexHeight/4; layer+=blockTexWidth) {
                memCopy(memAddress(buf) + row * blockTexWidth * 4L,
                        atlasBuffer.pointer.get(0) + offset + (((row+layer) * Textures.atlas.width + (i * blockTexWidthL)) * 4L),
                        blockTexWidth * 4L);
                for (long col = 0; col < blockTexWidth; col++) {
                    if (alt) {
                        long modRow = row+blockTexWidthHalf;
                        if (modRow >= blockTexWidth) {modRow -= blockTexWidth;}
                        memCopy(memAddress(buf) + ((((blockTexWidth - 1) - (modRow - 1 < 0 ? blockTexWidth - 1 : modRow - 1)) * blockTexWidth) + ((blockTexWidth - 1) - col)) * 4L,
                                atlasBuffer.pointer.get(0) + offset + ((((row + (layer + (blockTexHeight / 4))) * Textures.atlas.width) + col + (i * blockTexWidthL)) * 4L),
                                4L);
                    } else {
                        memCopy(memAddress(buf) + ((((blockTexWidth - 1) - row) * blockTexWidth) + ((blockTexWidth - 1) - col)) * 4L,
                                atlasBuffer.pointer.get(0) + offset + ((((row + (layer + (blockTexHeight / 4))) * Textures.atlas.width) + col + (i * blockTexWidthL)) * 4L),
        ...
        for (long row = 1; row < blockTexWidthHalf-1; row++) {
            for (long col = 0; col < blockTexWidth; col++) {
                memCopy(memAddress(buf) + ((row * blockTexWidth) + col) * 4L,
                        atlasBuffer.pointer.get(0) + offset + ((((((row - 1) * blockTexWidth) + blockTexWidth) * Textures.atlas.width) + col + (i * blockTexWidthL)) * 4L),
                        4L);
    ...
    public static void copyBottomSlabTexture(ByteBuffer buf, int i, boolean alt, long offset) {
        for (long row = 0; row < blockTexWidth; row++) {
            for (long layer = blockTexHeight/2; layer < blockTexHeight/1.5f; layer+=blockTexWidth) {
                if (!alt) {
                    memCopy(memAddress(buf) + row * blockTexWidth * 4L,
                            atlasBuffer.pointer.get(0) + offset + (((row + layer) * Textures.atlas.width + (i * blockTexWidthL)) * 4L),
                            blockTexWidth * 4L);
                ...
                for (long col = 0; col < blockTexWidth; col++) {
                    if (alt) {
                        long modRow = (((blockTexWidth-1)-row)+blockTexWidthHalf);
                        if (modRow >= blockTexWidth) {modRow -= blockTexWidth;}
                        memCopy(memAddress(buf) + ((modRow * blockTexWidth) + ((blockTexWidth-1)-col)) * 4L,
                                atlasBuffer.pointer.get(0) + offset + ((((row+layer) * Textures.atlas.width) + col + (i * blockTexWidthL)) * 4L),
                                4L);
                        memCopy(memAddress(buf) + ((((blockTexWidth - 1) - (row - 1 < 0 ? blockTexWidth - 1 : row - 1)) * blockTexWidth) + ((blockTexWidth - 1) - col)) * 4L,
                                atlasBuffer.pointer.get(0) + offset + ((((row + (layer + (blockTexHeight / 4))) * Textures.atlas.width) + col + (i * blockTexWidthL)) * 4L),
        ...
        for (long row = blockTexWidthHalf+1; row < blockTexWidth; row++) {
            for (long col = 0; col < blockTexWidth; col++) {
                memCopy(memAddress(buf) + ((row * blockTexWidth) + col) * 4L,
                        atlasBuffer.pointer.get(0) + offset + ((((((row - 1) * blockTexWidth) + blockTexWidth) * Textures.atlas.width) + col + (i * blockTexWidthL)) * 4L),
                        4L);

...
public class BlockTypes {
    ...
    public static BlockType
            AIR = create(new BlockType(blockTypeMap.size(), "misc/texture/air", new BlockProperties().blockSFX(new SFX[]{Sounds.CLOUD}, 0.75f, 0.75f, new SFX[]{Sounds.CLOUD}, 0.75f, 0.75f)
            ...
            GRASS = create(List.of(BlockTags.sediment, BlockTags.grass), new BlockType(blockTypeMap.size(), "plant/texture/grass",  new BlockProperties().ttb(200).blockSFX(new SFX[]{Sounds.GRASS_STEP2, Sounds.GRASS_STEP3}, 1, 1,
                    new SFX[]{Sounds.GRASS_STEP1, Sounds.GRASS_STEP2, Sounds.GRASS_STEP3}, 1, 1))),
            DIRT = create(List.of(BlockTags.sediment, BlockTags.dirt), new BlockType(blockTypeMap.size(), "natural/texture/dirt",  new BlockProperties().ttb(200).blockSFX(new SFX[]{Sounds.DIRT_STEP1, Sounds.DIRT_STEP2, Sounds.DIRT_STEP3}, 1, 1,
            ...
            KYANITE = create(List.of(BlockTags.rocks, BlockTags.crystals, BlockTags.blunt), new LightBlockType(blockTypeMap.size(), "geological/texture/kyanite",  (LightBlockProperties) (new LightBlockProperties().r(4).g(20).b(40)
                    .blockSFX(new SFX[]{Sounds.GLASS_STEP1, Sounds.GLASS_STEP2}, 1, 1, new SFX[]{Sounds.GLASS_STEP1, Sounds.GLASS_STEP2}, 1, 1)))),
            MARBLE = create(List.of(BlockTags.rocks, BlockTags.blunt), new BlockType(blockTypeMap.size(), "geological/texture/marble",  new BlockProperties()
            ...
            GLASS = create(List.of(BlockTags.blunt), new BlockType(blockTypeMap.size(), "crafted/texture/glass",  new BlockProperties().blockSFX(new SFX[]{Sounds.GLASS_STEP1, Sounds.GLASS_STEP2}, 1, 1,
            ...
            OAK_PLANK = create(List.of(BlockTags.planks), new BlockType(blockTypeMap.size(), "tree/texture/oak_planks",  new BlockProperties().ttb(200).blockSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 1, 1,
                    new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 1, 1))), //15
            OAK_LOG = create(new BlockType(blockTypeMap.size(), "tree/texture/oak_log",  new BlockProperties().ttb(200).blockSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 1, 1,
                    new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 1, 1))),
            OAK_LEAVES = create(List.of(BlockTags.leaves), new LeafBlockType(blockTypeMap.size(), "tree/texture/oak_leaves",  new BlockProperties().ttb(100).blockSFX(new SFX[]{Sounds.GRASS_STEP2, Sounds.GRASS_STEP3}, 1, 1,
            ...
            SAND = create(List.of(BlockTags.sediment, BlockTags.sand), new PowderBlockType(blockTypeMap.size(), "natural/texture/sand",  new BlockProperties().ttb(200).blockSFX(new SFX[]{Sounds.SAND_STEP1, Sounds.SAND_STEP2}, 0.45f, 1.33f,
            ...
            CLOUD = create(new BlockType(blockTypeMap.size(), "natural/texture/cloud",  new BlockProperties().blockSFX(new SFX[]{Sounds.CLOUD}, 0.75f, 0.75f, new SFX[]{Sounds.CLOUD}, 0.75f, 0.75f)
            ...
            DRY_MUD = create(List.of(BlockTags.soakers, BlockTags.sediment), new BlockType(blockTypeMap.size(), "natural/texture/dry_mud",  DIRT.blockProperties)),
            ...
            SNOW = create(new BlockType(blockTypeMap.size(), "natural/texture/snow",  new BlockProperties().ttb(200).blockSFX(new SFX[]{Sounds.GRAVEL_STEP1, Sounds.GRAVEL_STEP2}, 0.5f, 0.8f,
                    new SFX[]{Sounds.GRAVEL_STEP1, Sounds.GRAVEL_STEP2}, 0.5f, 0.8f))),
            GRAVEL = create(List.of(BlockTags.sediment), new PowderBlockType(blockTypeMap.size(), "natural/texture/gravel",  SAND.blockProperties.copy().blockSFX(new SFX[]{Sounds.GRAVEL_STEP1, Sounds.GRAVEL_STEP2}, 0.4f, 1,
            ...
            MUD = create(List.of(BlockTags.sediment), new BlockType(blockTypeMap.size(), "natural/texture/mud",  new BlockProperties().ttb(200).blockSFX(new SFX[]{Sounds.MUD_STEP1, Sounds.MUD_STEP2}, 0.66f, 0.66f,
                    new SFX[]{Sounds.MUD_STEP1, Sounds.MUD_STEP2}, 0.66f, 0.66f))),
            CLAY = create(List.of(BlockTags.sediment), new BlockType(blockTypeMap.size(), "natural/texture/clay",  MUD.blockProperties)),
            ...
            IRON_ORE = create(new BlockType(blockTypeMap.size(), "geological/texture/iron_ore",  new BlockProperties().blockSFX(new SFX[]{Sounds.METAL_SMALL_PLACE1, Sounds.METAL_SMALL_PLACE2}, 0.66f, 0.66f,
            ...
            STICK = create(new BlockType(blockTypeMap.size(), "natural/texture/stick",  new BlockProperties().isSolid(false).blocksLight(false).obstructsHeightmap(false).isFluidReplaceable(true).blockSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 1, 1,
                    new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 1, 1))),
            ...
            STEEL_FRAME = create(new BlockType(blockTypeMap.size(), "crafted/texture/steel_frame",  new BlockProperties().blocksLight(false).obstructsHeightmap(false).permeable(true).blockSFX(new SFX[]{Sounds.METAL_SMALL_PLACE1, Sounds.METAL_SMALL_PLACE2}, 0.66f, 0.66f,
                    new SFX[]{Sounds.METAL_SMALL_PLACE1, Sounds.METAL_SMALL_PLACE2}, 0.66f, 0.66f))),
            POWERED_VENT = create(new BlockType(blockTypeMap.size(), "crafted/texture/powered_vent",  new BlockProperties().blockSFX(new SFX[]{Sounds.METAL_SMALL_PLACE1, Sounds.METAL_SMALL_PLACE2}, 0.66f, 0.66f,
            ...
            ORANGE_SAND = create(List.of(BlockTags.sediment), new PowderBlockType(blockTypeMap.size(), "natural/texture/orange_sand",  SAND.blockProperties.copy())),
            ...
            RED_SAND = create(List.of(BlockTags.sediment, BlockTags.sand), new PowderBlockType(blockTypeMap.size(), "natural/texture/red_sand",  SAND.blockProperties.copy())), //70
            ...
            RED_GRAVEL = create(List.of(BlockTags.sediment), new PowderBlockType(blockTypeMap.size(), "natural/texture/red_gravel",  GRAVEL.blockProperties.copy())),
            WET_SAND = create(List.of(BlockTags.sediment, BlockTags.sand), new PowderBlockType(blockTypeMap.size(), "natural/texture/wet_sand",  SAND.blockProperties.copy()));

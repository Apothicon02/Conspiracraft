...
public class BlockTags {
    ...
    public static BlockTag scytheEfficient = new BlockTag();
    public static BlockTag spadeEfficient = new BlockTag();
    ...
    public static BlockTag chiselEfficient = new BlockTag();

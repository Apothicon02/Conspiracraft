...
tasks.withType<Jar> {
    manifest {
        attributes["Main-Class"] = "org.conspiracraft.game.Main"
    }
}
...
tasks {
    val fatJar = register<Jar>("fatJar") {
        ...
        manifest { attributes(mapOf("Main-Class" to "org.conspiracraft.game.Main")) } // Provided we set it up in the application plugin configuration
